    ...
    return (
        <div className="md:hidden">
            ...
            </div>
            {
                ...
                <div  ref={sidenavbarref} className={" flex-no-wrap "}>
                    <motion.div initial={{x:"-100vw"}} animate={{x:0}} transition={{type:"tween"}} className="w-64 z-40 h-full absolute bg-gray-800 shadow flex-col justify-between ">
